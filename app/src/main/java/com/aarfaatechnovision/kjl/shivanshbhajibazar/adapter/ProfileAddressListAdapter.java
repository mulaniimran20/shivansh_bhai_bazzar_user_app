...
public class ProfileAddressListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
    private List<AddressListModelNew> addressListModelNew;
    private Context mContext;
    private MyAccountFragment checkOutFragmnetNew;

    /**
     * setup Constructure
     */
    public ProfileAddressListAdapter(final List<AddressListModelNew> addressListModelNew, final Context mContext, final MyAccountFragment myAccountFragment) {
