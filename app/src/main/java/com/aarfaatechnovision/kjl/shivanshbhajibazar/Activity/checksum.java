...
import com.aarfaatechnovision.kjl.shivanshbhajibazar.model.JSONParser;
...
public class checksum extends AppCompatActivity implements PaytmPaymentTransactionCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mid = "XgQgfx03659378360249"; /// your marchant key
...
// vollye , retrofit, asynch
    ...
    public class sendUserDetailTOServerdd extends AsyncTask<ArrayList<String>, Void, String> {
        ...
        String url ="https://shivanshbhajibazzar.com/api/Paytm//generateChecksum.php";
