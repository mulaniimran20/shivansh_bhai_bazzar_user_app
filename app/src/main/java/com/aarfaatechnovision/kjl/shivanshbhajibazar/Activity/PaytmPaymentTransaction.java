...
import com.aarfaatechnovision.kjl.shivanshbhajibazar.model.Api;
import com.aarfaatechnovision.kjl.shivanshbhajibazar.model.Constants;
import com.aarfaatechnovision.kjl.shivanshbhajibazar.model.Paytm;
...
public class PaytmPaymentTransaction extends AppCompatActivity{
EditText orderid, custid;
@Override
protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_paytm_payment_transaction);
        //initOrderId();
...
public void onClick(View view) {
        Intent intent = new Intent(PaytmPaymentTransaction.this, checksum.class);
